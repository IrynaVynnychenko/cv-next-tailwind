export const translations = {
  en: {
    ...
    header: {
      ...
      role: 'Senior UI Engineer & Full Stack Developer',
    },
    about: {
      title: 'Iryna Vynnychenko',
      subtitle: 'Senior UI Engineer & Full Stack Developer | React, Next.js, SaaS, Telegram Mini Apps',
      tagline:
      ...
      whyItems: [
        ...
        'Senior UI Engineer & Full Stack: React, Next.js, TypeScript, UI/UX to Code, AI features in the product',
        'Direct contractor. Available for remote B2B contracts globally. Accountable for the result, not a handoff',
      ],
      bio2: 'Senior UI Engineer & Full Stack. React and Next.js in production.',
    ...
    skills: {
      title: 'Skills',
      subtitle: 'TypeScript, React, and Next.js: UI systems, APIs, and data in production',
      categories: [
        {
          title: 'Frontend',
          items: [
            'TypeScript, React, Next.js (App Router, Server Components, Server Actions, API Routes)',
            'Tailwind CSS, SCSS, CSS Modules, Styled Components, Shadcn/ui',
            'Design systems and custom component libraries',
            'GSAP, Framer Motion, Lottie',
            'Webflow, WordPress, static generation (SSG / HTML)',
          ],
        },
        {
    ...
    experience: {
      ...
      items: [
        {
          title: 'Senior UI Engineer & Full Stack Developer',
          company: 'Upwork',
          period: '2018 - Present',
    ...
    footer: {
      text: '© 2026 Iryna Vynnychenko - Senior UI Engineer & Full Stack Developer'
    },
    blog: {
  ...
  ua: {
    ...
    about: {
      ...
      whyItems: [
        ...
        'Senior UI Engineer & Full Stack: React, Next.js, TypeScript, UI/UX to Code, AI-функції в продукті',
    ...
    skills: {
      title: 'Навички',
      subtitle: 'TypeScript, React і Next.js: UI-системи, API та дані в продакшені',
      categories: [
        {
          title: 'Frontend',
          items: [
            'TypeScript, React, Next.js (App Router, Server Components, Server Actions, API Routes)',
            'Tailwind CSS, SCSS, CSS Modules, Styled Components, Shadcn/ui',
            'Дизайн-системи та власні бібліотеки компонентів',
            'GSAP, Framer Motion, Lottie',
            'Webflow, WordPress, статична генерація (SSG / HTML)',
          ],
        },
        {
  ...
  de: {
    ...
    about: {
      title: 'Iryna Vynnychenko',
      subtitle: 'Senior UI Engineer & Full Stack Developerin | React, Next.js, SaaS, Telegram Mini Apps',
      tagline:
      ...
      whyItems: [
        ...
        'Senior UI Engineer & Full Stack: React, Next.js, TypeScript, UI/UX to Code, KI-Features im Produkt',
        'Direkte Auftragnehmerin. Verfügbar für Remote-B2B-Verträge weltweit. Verantwortung für das Ergebnis, kein Handoff',
      ],
      bio2: 'Senior UI Engineer & Full Stack. React und Next.js in Produktion.',
    ...
    skills: {
      title: 'Kompetenzen',
      subtitle: 'TypeScript, React und Next.js: UI-Systeme, APIs und Daten in Produktion',
      categories: [
        {
          title: 'Frontend',
          items: [
            'TypeScript, React, Next.js (App Router, Server Components, Server Actions, API Routes)',
            'Tailwind CSS, SCSS, CSS Modules, Styled Components, Shadcn/ui',
            'Design Systems und eigene Komponentenbibliotheken',
            'GSAP, Framer Motion, Lottie',
            'Webflow, WordPress, statische Generierung (SSG / HTML)',
          ],
        },
        {
  ...
  fr: {
    ...
    skills: {
      title: 'Compétences',
      subtitle: 'TypeScript, React et Next.js : systèmes d’UI, API et données en production',
      categories: [
        {
          title: 'Frontend',
          items: [
            'TypeScript, React, Next.js (App Router, Server Components, Server Actions, API Routes)',
            'Tailwind CSS, SCSS, CSS Modules, Styled Components, Shadcn/ui',
            'Design systems et bibliothèques de composants sur mesure',
            'GSAP, Framer Motion, Lottie',
            'Webflow, WordPress, génération statique (SSG / HTML)',
          ],
        },
        {
  ...
  es: {
    ...
    skills: {
      title: 'Habilidades',
      subtitle: 'TypeScript, React y Next.js: sistemas de UI, APIs y datos en producción',
      categories: [
        {
          title: 'Frontend',
          items: [
            'TypeScript, React, Next.js (App Router, Server Components, Server Actions, API Routes)',
            'Tailwind CSS, SCSS, CSS Modules, Styled Components, Shadcn/ui',
            'Design systems y bibliotecas de componentes propias',
            'GSAP, Framer Motion, Lottie',
            'Webflow, WordPress, generación estática (SSG / HTML)',
          ],
        },
        {
  ...
  it: {
    ...
    skills: {
      title: 'Competenze',
      subtitle: 'TypeScript, React e Next.js: sistemi UI, API e dati in produzione',
      categories: [
        {
          title: 'Frontend',
          items: [
            'TypeScript, React, Next.js (App Router, Server Components, Server Actions, API Routes)',
            'Tailwind CSS, SCSS, CSS Modules, Styled Components, Shadcn/ui',
            'Design system e librerie di componenti su misura',
            'GSAP, Framer Motion, Lottie',
            'Webflow, WordPress, generazione statica (SSG / HTML)',
          ],
        },
        {
  ...
  tr: {
    ...
    about: {
      ...
      whyItems: [
        ...
        'Senior UI Engineer & Full Stack: React, Next.js, TypeScript, UI/UX to Code, üründe yapay zekâ özellikleri',
        'Doğrudan yüklenici. Dünya genelinde uzaktan B2B sözleşmelerine açığım. Handoff değil, sonuçtan sorumlu',
      ],
      bio2: 'Senior UI Engineer & Full Stack. Üretimde React ve Next.js.',
    ...
    skills: {
      title: 'Yetkinlikler',
      subtitle: 'TypeScript, React ve Next.js: üretimde UI sistemleri, API’ler ve veri',
      categories: [
        {
          title: 'Frontend',
          items: [
            'TypeScript, React, Next.js (App Router, Server Components, Server Actions, API Routes)',
            'Tailwind CSS, SCSS, CSS Modules, Styled Components, Shadcn/ui',
            'Tasarım sistemleri ve özel bileşen kütüphaneleri',
            'GSAP, Framer Motion, Lottie',
            'Webflow, WordPress, statik üretim (SSG / HTML)',
          ],
        },
        {
