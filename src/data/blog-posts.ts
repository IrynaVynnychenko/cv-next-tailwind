...
export type RawBlogPost = {
  ...
  tags: { en: string[]; ua: string[]; de?: string[] }
  content: LocalizedSection[]
}

export type BlogLang = 'en' | 'ua' | 'de'
...
export const rawBlogPosts: RawBlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      de: "Benutzerdefinierte Architektur und Frontend: Handgefertigte Next.js- oder React-Webanwendungen, die für Geschwindigkeit, SEO und visuelle Ästhetik optimiert sind und reibungslose Mikroanimationen und keine Layoutverschiebungen gewährleisten.",
          },
          {
...
export function getBlogPagePath(page: number, lang: BlogLang = 'en'): string {
  const prefix = lang === 'ua' ? '/ua' : lang === 'de' ? '/de' : ''
