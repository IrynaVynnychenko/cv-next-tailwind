...
export const businessPosts: RawBlogPost[] = [
  {
    ...
    excerpt: {
      ...
      de: 'Nachhilfe, Nagelstudio, Café mit vier Tischen: Sie brauchen kein 40-Seiten-Portal. Eine schnelle Seite, die Ihnen gehört — Instagram, Telegram und Maps sind Pacht, und Fremde prüfen Sie vor der Zahlung.',
      fr: 'Prof particulier, manucure, café de quatre tables : pas besoin d’un portail de 40 pages. Une page rapide à vous — Instagram, Telegram et Maps sont une location, et un inconnu vous vérifie avant de payer.',
      es: 'Clases, manicura, un café de cuatro mesas: no necesita un portal de 40 páginas. Una página rápida suya — Instagram, Telegram y Maps son alquiler, y un desconocido le comprueba antes de pagar.',
      it: 'Ripetizioni, unghie, un caffè da quattro tavoli: non serve un portale da 40 pagine. Una pagina veloce vostra — Instagram, Telegram e Maps sono affitto, e uno sconosciuto vi controlla prima di pagare.',
