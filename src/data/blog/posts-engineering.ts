...
export const engineeringPosts: RawBlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      de: "Planen Sie, Ihr nächstes Webprojekt auf Next.js und Vercel zu erstellen oder zu migrieren? Melden Sie sich! Ich baue leistungsstarke React-Architekturen, die für maximale Geschwindigkeit, SEO-Sichtbarkeit und saubere Telemetrie optimiert sind. Schreiben Sie mir noch heute, um Ihr nächstes modernes digitales Produkt auf den Markt zu bringen.",
      fr: "Envisagez-vous de créer ou de migrer votre prochain projet Web vers Next.js et Vercel ? Parlons-en ! Je construis des architectures React hautes performances optimisées pour une vitesse maximale, une visibilité SEO et une télémétrie propre. Écrivez-moi dès aujourd'hui pour lancer votre prochain produit numérique moderne.",
  ...
  },
  {
    ...
    content: [
      ...
      de: "Schreiben Sie mir über das unten stehende Kontaktformular und lassen Sie uns ein Sucherlebnis schaffen, das aus Besuchern treue Kunden macht!",
      fr: "Écrivez-moi en utilisant le formulaire de contact ci-dessous et construisons une expérience de recherche qui transforme les visiteurs en clients fidèles !",
  ...
  },
  {
    ...
    content: [
      ...
      de: "Wenn Sie ein Figma-Design haben und einen Frontend-Entwickler suchen, der Ihre kreative Vision respektiert und sauberen, fehlerfreien und leistungsstarken React-Code ohne Mikromanagement liefert, dann lassen Sie uns reden! Schreiben Sie mir über das Kontaktformular unten für eine kostenlose technische Beratung oder Überprüfung Ihrer Figma-Datei.",
      fr: "Si vous avez une conception Figma et recherchez un développeur frontend qui respecte votre vision créative et fournit du code React propre, sans bug et hautes performances sans micro-gestion, parlons-en ! Écrivez-moi via la section contact ci-dessous pour une consultation technique gratuite ou un examen de votre fichier Figma.",
  ...
  },
  {
    ...
    content: [
      ...
      de: "Sind Sie bereit, eine neue Webplattform zu starten, oder möchten Sie Ihre aktuelle Codebasis auf Architekturlücken überprüfen? Schreiben Sie mir über das Kontaktformular unten für eine kostenlose technische Beratung!",
      fr: "Envie de lancer une nouvelle plateforme web ou souhaitez-vous vérifier votre base de code actuelle pour détecter les lacunes architecturales ? Écrivez-moi via la section contacts ci-dessous pour une consultation technique gratuite !",
  ...
  },
  {
    ...
    content: [
      ...
      de: "Haben Sie ein komplexes Figma-Design zur Entwicklung bereit oder möchten Sie Ihre aktuelle Site-Implementierung überprüfen? Schreiben Sie mir über das Kontaktformular unten für eine visuelle Prüfung und Projektberatung!",
      fr: "Vous avez une conception Figma complexe prête à être développée ou souhaitez revoir la mise en œuvre actuelle de votre site ? Écrivez-moi via la section contacts ci-dessous pour un audit visuel et une consultation de projet !",
  ...
  },
  {
    ...
    content: [
      ...
      de: "Benötigen Sie eine Neugestaltung der Mobile-First-Website oder ein neues Webprodukt? Schreiben Sie mir über das Kontaktformular für eine Beratung zu Ihrem Projekt!",
      fr: "Besoin d'une reconstruction de site Web axée sur le mobile ou d'un nouveau produit Web ? Écrivez-moi via la section contacts pour une consultation sur votre projet !",
