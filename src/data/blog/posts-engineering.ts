...
export const engineeringPosts: RawBlogPost[] = [
  ...
  },
  {
    ...
    title: {
      ...
      ua: 'Чому бізнесу в 2026 потрібен розумний пошук на сайті: від рядка до двигуна продажів',
      de: 'Warum Ihr Unternehmen 2026 eine starke Site-Suche braucht: von der Suchleiste zur Sales-Maschine',
      fr: "Pourquoi votre business a besoin d'une recherche avancée en 2026 : de la barre au moteur de ventes",
      es: "Por qué su negocio necesita una búsqueda avanzada en 2026: de la barra de search a un motor de ventas",
      it: "Perché il vostro business ha bisogno di una ricerca avanzata nel 2026: dalla search bar a un motore di vendite",
      tr: "İşiniz 2026’da neden gelişmiş site aramasına ihtiyaç duyar: arama çubuğundan satış motoruna",
    },
    excerpt: {
  ...
  },
  {
    ...
    title: {
      ...
      ua: 'Чому бізнесу потрібен швидкий сайт на Next.js',
      de: 'Warum Ihr Unternehmen eine schnelle Next.js-Website braucht',
      fr: "Pourquoi votre business a besoin d'un site Next.js rapide",
      es: 'Por qué su negocio necesita un sitio Next.js de alto rendimiento',
      it: 'Perché il vostro business ha bisogno di un sito Next.js ad alte prestazioni',
      tr: 'İşiniz neden yüksek performanslı bir Next.js sitesine ihtiyaç duyar',
    },
    excerpt: {
