...
export const chrome: Record<Language, ChromeCopy> = {
  en: {
    ...
    to: 'to',
    heroHeadline: 'Frontend & fullstack Next.js',
    heroCta: 'Book a call',
    heroFor: 'for',
  ...
  ua: {
    ...
    to: '-',
    heroHeadline: 'Фронтенд і fullstack Next.js',
    heroCta: 'Book a call',
    heroFor: 'для',
  ...
  fr: {
    ...
    to: 'à',
    heroHeadline: 'Frontend & Next.js fullstack',
    heroCta: 'Book a call',
    heroFor: 'pour',
  ...
  es: {
    ...
    to: 'a',
    heroHeadline: 'Frontend y Next.js fullstack',
    heroCta: 'Book a call',
    heroFor: 'para',
  ...
  it: {
    ...
    to: 'a',
    heroHeadline: 'Frontend e Next.js fullstack',
    heroCta: 'Book a call',
    heroFor: 'per',
  ...
  tr: {
    ...
    to: '-',
    heroHeadline: 'Frontend ve fullstack Next.js',
    heroCta: 'Book a call',
    heroFor: 'için',
