...
export default function ChartsDemoIsland() {
  ...
  useEffect(() => {
    ...
    let cancelled = false
    import('./PythonLibsCharts').then((mod) => {
  ...
  return (
    <figure ref={hostRef} className="my-8" aria-label={label}>
      {Scene ? (
        ...
        <div className="flex h-[320px] items-center justify-center border border-foreground/20 bg-background">
