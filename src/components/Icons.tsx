...
export const ViberIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    <path d="M11.4.002C9.432.028 5.347.344 3.078 2.61.184 5.438.006 10.343 0 11.82c-.016 2.354.545 4.333 1.67 5.877.172.237.336.412.336.412l.07 2.68c.036.86.684 1.193 1.446.745l2.404-1.387s.592.148 1.028.248c2.05.48 3.887.57 5.878.445 7.143-.44 8.331-5.49 8.547-9.77.53-10.48-8.54-11.07-9.98-11.07zm.13 16.51c-1.02.01-1.82-.08-2.67-.28-.32-.07-.96-.3-1.08-.34-.13-.05-.23.04-.23.04l-1.64.95.1-1.84s-.22-.17-.35-.35c-.88-1.2-1.32-2.73-1.31-4.56.04-3.47 2.9-6.3 6.47-6.33 4.54-.04 6.55 3.5 6.55 6.64 0 4.16-2.7 6.1-5.84 6.12z" />
  </svg>
)
...
export const UpworkIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
