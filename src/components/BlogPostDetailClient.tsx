...
const ctaCopy = {
  title: {
    ...
    es: '¿Listo para hablar de tu proyecto?',
    it: 'Pronto a parlare del tuo progetto?',
    tr: 'Projenizi konuşmaya hazır mısınız?',
  },
  desc: {
    ...
    es: 'Soy ingeniera web senior especializada en React y Next.js — disponible para proyectos freelance en todo el mundo.',
    it: 'Sono un’ingegnera web senior specializzata in React e Next.js — disponibile per progetti freelance in tutto il mondo.',
    tr: 'React ve Next.js konusunda uzman kıdemli bir web mühendisiyim — dünya çapında freelance projelere açığım.',
  },
  orderApp: {
    ...
    tr: 'Bir web uygulaması sipariş edin',
  },
  oneClick: {
    en: 'Hire in 1 click',
    ua: 'Найм в 1 клік',
  ...
  orderAppDesc: {
    ...
    es: '¿Listo para crear una aplicación web moderna, rápida y escalable para tu negocio? Empieza hoy un contrato seguro en Upwork.',
    it: 'Pronto a costruire un’applicazione web moderna, veloce e scalabile per la tua azienda? Avvia oggi un contratto sicuro su Upwork.',
    tr: 'İşletmeniz için modern, hızlı ve ölçeklenebilir bir web uygulaması geliştirmeye hazır mısınız? Bugün Upwork’te güvenli bir sözleşme başlatın.',
  },
  oneClickDesc: {
    ...
    es: 'Contrátame como desarrolladora en 1 clic. Empieza un contrato seguro en Upwork para crear soluciones web de alta conversión para tu negocio.',
    it: 'Assumimi come sviluppatrice in 1 clic. Avvia un contratto sicuro su Upwork per costruire soluzioni web ad alta conversione per la tua azienda.',
    tr: 'Beni 1 tıkla geliştiriciniz olarak işe alın. İşletmeniz için yüksek dönüşümlü web çözümleri geliştirmek üzere Upwork’te güvenli bir sözleşme başlatın.',
  },
  orderUpwork: {
    en: 'Order a web application',
